...
export const TimelineTrack: React.FC<TimelineTrackProps> = ({ lineRef, progressRef }) => {
    return (
        <>
            ...
            <div className="absolute left-4 lg:left-1/2 top-0 bottom-[22rem] lg:bottom-[10rem] w-[2px] bg-gray-200 -translate-x-[120%] lg:-translate-x-1/2 z-0"></div>
            ...
            <div ref={lineRef} className="absolute left-4 lg:left-1/2 top-0 bottom-[22rem] lg:bottom-[10rem] w-[3px] -translate-x-[120%] lg:-translate-x-1/2 z-10 pointer-events-none overflow-hidden">
                <div
                    ref={progressRef}
