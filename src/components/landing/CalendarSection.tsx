...
export function CalendarSection() {
  ...
  return (
    <section className="py-20 px-2 lg:px-4 bg-gray-50 text-gray-800 font-sans min-h-screen">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start justify-center">
                ...
                <div className="bg-white shadow-md p-6 mb-4">
                  ...
                  <div className="space-y-2 mt-6">
                    {selectedDayData.events.map((event, idx) => (
                         <div key={idx} className="flex justify-between items-center py-2 border-b border-gray-50 last:border-0 hover:bg-gray-50 px-2 transition-colors">
            ...
            <div className="w-full lg:w-[320px] shrink-0 sticky top-4 self-start">
                                ...
                                return (
                                    <button
                                        ...
                                        className={clsx(
                                            ...
                                            isSelected ? "bg-amber-500 text-white shadow-lg ring-2 ring-amber-200" : "text-gray-600 hover:text-amber-600",
