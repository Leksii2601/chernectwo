...
const sketes = [
    {
        ...
        description: 'Місце тиші та молитви, розташоване посеред лісу. Ідеальне для усамітнення та духовних роздумів.',
        image: '/media/hero-1.jpg',
        link: '#holy-spirit'
    },
    {
        id: 2,
        title: 'Скит Живоносне джерело',
        description: 'Медичний центр та храм, де надається духовна та тілесна допомога всім, хто її потребує.',
    ...
    },
    {
        ...
        description: 'Осередок братерської праці та молитви, де ченці несуть свій послух серед природи.',
