  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="py-12 px-4 max-w-4xl mx-auto">
        <h2 className="font-montserrat text-2xl font-bold text-center mb-8">{t('donate.quick_help')}</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border-2 border-amber-500 rounded-xl p-6 hover:shadow-xl transition-shadow bg-gradient-to-br from-amber-50 to-white">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-montserrat text-lg font-bold">{t('donate.privatbank_card')}</h3>
            </div>
            <div className="group relative bg-white p-4 rounded-lg cursor-pointer border border-gray-200 hover:border-amber-500 transition-colors" onClick={() => copyToClipboard('5363542096233375')}>
              ...
              <p className="text-sm text-gray-600 text-center">{t('donate.click_to_copy')}</p>
          ...
          <div className="border-2 border-gray-300 rounded-xl p-6 bg-gray-50 opacity-60">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-montserrat text-lg font-bold text-gray-600">{t('donate.international')}</h3>
            </div>
            <div className="bg-white p-4 rounded-lg border border-gray-200">
              <p className="text-sm text-gray-500 text-center whitespace-pre-line">{t('donate.paypal_soon')}</p>
            </div>
          </div>
      ...
      <section className="py-16 px-4 max-w-7xl mx-auto">
        <h2 className="font-montserrat text-2xl font-bold text-center mb-12">{t('donate.bank_details')}</h2>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="p-6">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="font-montserrat text-xl font-bold">{t('donate.uah')}</h2>
            </div>
            ...
            <div className="space-y-3">
              <div className="group relative bg-gray-50 p-3 rounded-lg cursor-pointer" onClick={() => copyToClipboard('РО СВЯТО-МИКОЛАЇВСЬКИЙ ЧОЛОВІЧИЙ МОНАСТИР')}>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">{t('donate.recipient')}</p>
              ...
              <div className="group relative bg-gray-50 p-3 rounded-lg cursor-pointer" onClick={() => copyToClipboard('26278106')}>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">{t('donate.edrpou')}</p>
              ...
              <div className="group relative bg-gray-50 p-3 rounded-lg cursor-pointer" onClick={() => copyToClipboard('UA7730529900000026006000812444')}>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">{t('donate.iban')}</p>
              ...
              <div className="group relative bg-gray-50 p-3 rounded-lg cursor-pointer" onClick={() => copyToClipboard('305299')}>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">{t('donate.mfo')}</p>
              ...
              <div className="group relative bg-gray-50 p-3 rounded-lg cursor-pointer" onClick={() => copyToClipboard('АТ КБ «ПриватБанк»')}>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">{t('donate.bank')}</p>
                <p className="font-medium text-sm">АТ КБ «ПриватБанк»</p>
                <Copy className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 group-hover:text-amber-500 transition-colors" />
              </div>

              <div className="group relative bg-gray-50 p-3 rounded-lg cursor-pointer" onClick={() => copyToClipboard(t('donate.payment_purpose_val'))}>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">{t('donate.payment_purpose')}</p>
                <p className="font-medium text-sm">{t('donate.payment_purpose_val')}</p>
                <Copy className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 group-hover:text-amber-500 transition-colors" />
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="font-montserrat text-xl font-bold">{t('donate.usd')}</h2>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="group relative bg-gray-50 p-3 rounded-lg cursor-pointer" onClick={() => copyToClipboard('PBANUA2X')}>
                <p className="text-xs text-gray-500 uppercase tracking-wider mb-1">{t('donate.swift')}</p>
                <p className="font-mono text-lg">PBANUA2X</p>
                <Copy className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 group-hover:text-amber-500 transition-colors" />
              </div>

              <div className="bg-blue-50 p-3 rounded-lg border border-blue-200">
                <p className="text-xs text-blue-700 font-medium">{t('donate.correspondent_banks')}</p>
          ...
          <div className="p-6">
            <div className="flex items-center gap-4 mb-6">
              ...
              <h2 className="font-montserrat text-xl font-bold">{t('donate.eur')}</h2>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-indigo-50 p-3 rounded-lg border border-indigo-200">
                <p className="text-xs text-indigo-700 font-medium">{t('donate.correspondent_banks')}</p>
      ...
      <section className="py-8 px-4 max-w-4xl mx-auto text-center">
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-6">
          <p className="text-sm text-gray-700">
            <strong>{t('donate.payment_purpose')}:</strong> &quot;{t('donate.payment_purpose_val')}&quot;<br />
            {t('donate.payment_purpose_desc')}
          </p>
        </div>
      </section>
      ...
      {showCopyModal && mounted && createPortal(
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[9999] animate-in slide-in-from-bottom-5 fade-in duration-300">
          <div className="bg-gray-900 text-white px-6 py-3 rounded-full shadow-lg flex items-center gap-3 border border-gray-800">
            ...
            <span className="font-medium text-sm">{t('donate.copied')}</span>
          </div>
        </div>,
        document.body
      )}
