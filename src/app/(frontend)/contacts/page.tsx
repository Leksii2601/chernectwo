         ...
         <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div className="space-y-16 py-4">
                <div className="flex items-start gap-6">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-2">Адреса</h3>
                        <p className="text-xl text-gray-800 leading-relaxed max-w-sm">
                            45240 Волинська область,<br/>
                            Ківерцівський р-н, с. Жидичин,<br/>
                            вул. Ковельська, 1
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-start gap-6">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-2">Телефон</h3>
                ...
                <div className="flex items-start gap-6">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-gray-400 uppercase tracking-widest mb-2">Електронна пошта</h3>
